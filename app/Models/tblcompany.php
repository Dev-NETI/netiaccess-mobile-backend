...
class tblcompany extends Model
{
    ...
    protected $fillable = ['company', 'designation', 'addressline1', 'addressline2', 'addressline3',
     'position', 'busprice', 'deletedid', 'default_currency',
     'billing_statement_format', 'lastpde_serialnumber','billing_statement_template','toggleBillingEmailNotification'];
